                ...
                if question_phrase in normalized_title:
                    ...
                    if question_phrase in questions[0]:
                        if submission.subreddit == "designjobs":
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, content='New job posting added to /designjobs!')
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, content='New job posting added to /forhire!')
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, content='New job posting added to /hireawriter!')
                        ...
                        webhook = DiscordWebhook(url=webhook_urls, content='New job posting added to /slavelabour!') 
