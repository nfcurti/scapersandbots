                ...
                if question_phrase in normalized_title:
                    ...
                    if question_phrase in questions[0]:
                        if submission.subreddit == "designjobs":
                            ...
                            airtable.insert({'title': submission.title}, {'url': submission.url}, {'author': submission.author}, {'type': 'Design'} )
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, title='New job posting added!')
                            airtable.insert({'title': submission.title}, {'url': submission.url}, {'author': submission.author}, {'type': 'Misc'} )
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, title='New job posting added!')
                            airtable.insert({'title': submission.title}, {'url': submission.url}, {'author': submission.author}, {'type': 'Writing'} )
                            ...
                            webhook = DiscordWebhook(url=webhook_urls, title='New job posting added!')
                            airtable.insert({'title': submission.title}, {'url': submission.url}, {'author': submission.author}, {'type': 'IT'} )
